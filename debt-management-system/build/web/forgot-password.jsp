<%-- 
    ...
    Created on : Mar 1, 2023, 11:40:59 PM
    Author     : bang
--%>
                            ...
                            <div class="row no-gutters">
                                <div class="col-xl-12">
                                    <div class="auth-form">
                                        ...
                                        <h4 class="text-center mb-4 text-white">Quên mật khẩu</h4>
                                        ...
                                        <form class="form-valide" action="forgot-password" method="POST">
                                            ...
                                            <div class="text-center">
                                                <button type="submit" class="btn bg-white text-primary btn-block">Gửi</button>
                                            </div>
                                        </form>
                                        </br>
